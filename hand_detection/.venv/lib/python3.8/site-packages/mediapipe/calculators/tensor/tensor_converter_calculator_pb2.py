...
_TENSORCONVERTERCALCULATOROPTIONS = DESCRIPTOR.message_types_by_name['TensorConverterCalculatorOptions']
_TENSORCONVERTERCALCULATOROPTIONS_TENSORFLOATRANGE = _TENSORCONVERTERCALCULATOROPTIONS.nested_types_by_name['TensorFloatRange']
TensorConverterCalculatorOptions = _reflection.GeneratedProtocolMessageType('TensorConverterCalculatorOptions', (_message.Message,), {

  'TensorFloatRange' : _reflection.GeneratedProtocolMessageType('TensorFloatRange', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TENSORCONVERTERCALCULATOROPTIONS._serialized_start=116
  _TENSORCONVERTERCALCULATOROPTIONS._serialized_end=633
  _TENSORCONVERTERCALCULATOROPTIONS_TENSORFLOATRANGE._serialized_start=497
  _TENSORCONVERTERCALCULATOROPTIONS_TENSORFLOATRANGE._serialized_end=541
